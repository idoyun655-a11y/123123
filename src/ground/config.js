...
export const GROUND_CONFIG = Object.freeze({
  ...
  tasks: Object.freeze({
    AircraftArrival: Object.freeze({ durationMinutes: 3, requiredStaff: 1, required: true, roleIds: ['RampCoordinator'] }),
    ...
    Cleaning: Object.freeze({ durationMinutes: 15, requiredStaff: 4, required: true, roleIds: ['CleaningCrew', 'GroundHandler'] }),
    Catering: Object.freeze({ durationMinutes: 10, requiredStaff: 3, required: false, roleIds: ['CateringCrew'] }),
    Refueling: Object.freeze({ durationMinutes: 15, requiredStaff: 3, required: false, roleIds: ['RefuelingCrew'] }),
    BoardingSupport: Object.freeze({ durationMinutes: 10, requiredStaff: 3, required: true, roleIds: ['GroundHandler', 'RampCoordinator'] }),
    BaggageLoad: Object.freeze({ durationMinutes: 12, requiredStaff: 4, required: true, roleIds: ['BaggageHandler', 'GroundHandler'] }),
